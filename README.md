...
Fourteen pull requests are merged; `src/` holds 110 files and `test/` 91, with
723 unit tests across 75 files and 24 Playwright browser journeys, all green.
...
| `npm test` | Unit tests (Vitest) — 723 tests across 75 files, including the composition-loop eval corpus (see [`docs/evals.md`](docs/evals.md)) |
